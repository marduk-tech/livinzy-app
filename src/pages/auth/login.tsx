  ...
  return (
    <div style={{ maxWidth: 300, margin: "auto", padding: "50px 0" }}>
      ...
      <Form
        form={form}
        layout="vertical"
        onFinish={loginStatus === "OTP_SENT" ? handleLogin : handleGenerateOtp}
      >
                    ...
                    },
                    {
                      validator: (_, value) =>
                        value && value.toString().length === 10
                          ? Promise.resolve()
                          : Promise.reject(
                              new Error("Mobile number must be 10 digits long!")
                            ),
                    },
                  ]}
                ...
                {loginStatus === "OTP_SENT" && (
                  <>
                    ...
                    <Button
                      ...
                      type="link"
                      onClick={() =>
                        generateOtp({ mobile: getFieldValue("mobileNumber") })
                      }
                      size="small"
                    >
                      {resendTimer > 0 ? (
